...
class ContextBuilder:
    ...
    def __init__(
        ...
        self.memory = MemoryStore(workspace, memory_dir=memory_dir)
...
- After completing a significant task, **immediately summarize** the key results and save to memory before responding.
