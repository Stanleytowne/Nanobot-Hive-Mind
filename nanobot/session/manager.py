...
class Session:
    ...
    def get_history(self, max_messages: int = 500) -> list[dict[str, Any]]:
        ...
        for m in sliced:
            ...
            entry: dict[str, Any] = {"role": m["role"], "content": content if content is not None else ""}
...
class SessionManager:
    ...
    def __init__(self, workspace: Path, session_dir: Path | None = None):
        self.workspace = workspace
        self.sessions_dir = ensure_dir(session_dir or (self.workspace / "sessions"))
